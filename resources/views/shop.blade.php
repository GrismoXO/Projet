<x-app-layout>
    ...
    <x-slot name="header">
      ...
      <div class="flex flex-col justify-center items-center h-full gift_800">
        <h1 class="text-4xl kalam h1_500 pt_350 pt_8 ">Notre sélection de produits bien-être</h1>
        <p class="pt-6 open text-xl w-1/2 text-center text_500_2 none_500">J'ai sélectionné avec soin les meilleurs produits, pour votre bien-être.</p>
    </div>
      </x-slot>
    <x-slot name="slot">
      @if (session('success'))
      ...
      <div class="bg-white flex justify-center pb-20">
        <section class="pt-8 party flex flex-col">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-4/5">
